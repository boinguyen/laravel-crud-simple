 ...
 * Generated for Laravel 5.2.45 on 2017-01-04.
 *
...
namespace {
    ...
    class Messenger extends \App\Facades\Messenger{

        /**
         * set currently authenticated user id for global usage
         *
         * @param int $id
         * @return \App\Helpers\int/bool
         * @static
         */
        public static function setAuthUserId($id = null){
            return \App\Helpers\Messenger::setAuthUserId($id);
        }
         ...
         *
         * @param int $userId
         * @return \App\Helpers\bool/int
         * @static
         */
        public static function isConversationExists($userId){
            return \App\Helpers\Messenger::isConversationExists($userId);
        }
        ...
        public static function isAuthenticUser($conversationId, $userId){
            return \App\Helpers\Messenger::isAuthenticUser($conversationId, $userId);
        }
         ...
         * @param $type
         * @param $message
         * @return \App\Helpers\Message|bool
         * @static
         */
        public static function sendMessage($id, $type, $message){
            return \App\Helpers\Messenger::sendMessage($id, $type, $message);
        }
        ...
        public static function sendMessageByUserId($receiverId, $message){
            return \App\Helpers\Messenger::sendMessageByUserId($receiverId, $message);
        }
         ...
         * @static
         */
        public static function getInbox($offset = 0, $take = 20){
            return \App\Helpers\Messenger::getInbox($offset, $take);
        }
         ...
         * @static
         */
        public static function getInboxAll($offset = 0, $take = 20){
            return \App\Helpers\Messenger::getInboxAll($offset, $take);
        }
         ...
         * @static
         */
        public static function getConversationById($application_id){
            return \App\Helpers\Messenger::getConversationById($application_id);
        }
         ...
         * @static
         */
        public static function getConversationsByUserId($senderId){
            return \App\Helpers\Messenger::getConversationsByUserId($senderId);
        }
        ...
        public static function makeSeen($messageId){
            return \App\Helpers\Messenger::makeSeen($messageId);
        }
         ...
         *
         * @param int $conversationId
         * @return \App\Helpers\UserModel
         * @static
         */
        public static function getReceiverInfo($conversationId){
            return \App\Helpers\Messenger::getReceiverInfo($conversationId);
        }
        ...
        public static function deleteMessage($messageId){
            return \App\Helpers\Messenger::deleteMessage($messageId);
        }
        ...
        public static function deleteForever($messageId){
            return \App\Helpers\Messenger::deleteForever($messageId);
        }
        ...
        public static function deleteConversations($id){
            return \App\Helpers\Messenger::deleteConversations($id);
        }
        ...
        public static function getProjects(){
            return \App\Helpers\Messenger::getProjects();
        }
        ...
        public static function getApplications(){
            return \App\Helpers\Messenger::getApplications();
        }
        ...
        public static function getMessagesCount(){
            return \App\Helpers\Messenger::getMessagesCount();
        }
    ...
    class LanguageSwitcher extends \ied3vil\LanguageSwitcher\Facades\LanguageSwitcher{
         ...
         * @static
         */
        public static function registerLanguage(){
            return \ied3vil\LanguageSwitcher\LanguageSwitcher::registerLanguage();
        }
        ...
        public static function getCurrentLanguage(){
            return \ied3vil\LanguageSwitcher\LanguageSwitcher::getCurrentLanguage();
        }
        ...
        public static function setLanguage($language){
            return \ied3vil\LanguageSwitcher\LanguageSwitcher::setLanguage($language);
        }
        ...
        public static function getStorageMethod(){
            return \ied3vil\LanguageSwitcher\LanguageSwitcher::getStorageMethod();
        }
        ...
        public static function getLanguageKey(){
            return \ied3vil\LanguageSwitcher\LanguageSwitcher::getLanguageKey();
        }
         ...
         * @static
         */
        public static function getSwitchPath(){
            return \ied3vil\LanguageSwitcher\LanguageSwitcher::getSwitchPath();
        }
        ...
        public static function getRedirect(){
            return \ied3vil\LanguageSwitcher\LanguageSwitcher::getRedirect();
        }
        ...
        public static function getRedirectRoute(){
            return \ied3vil\LanguageSwitcher\LanguageSwitcher::getRedirectRoute();
        }
